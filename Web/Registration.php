    ...
    <div class="form_content" id="2">
        <div class="form_text">
            <form onsubmit="false" action="" method="POST">
                <h3>Register</h3>
                <input type="text" required="" class="input" name="name" placeholder="Name" id="name">  
                    <input type="text" required="" class="input" name="number" placeholder="Phone Number" id="number">
